<script lang="ts" src="./FilterByName.ts" />

<template>

  <div class="">
    <div class="w-full mb-8 inline-flex flex-col justify-center relative text-gray-500">
        ...
        <div class="relative">
            <input
                ...
                v-model="name"
                type="search"
                class="w-full box-shadow-custom  Montserrat bg-white p-3 pl-9 rounded focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent" 
                placeholder="Search"
                 />

            <svg class="w-4 h-4 absolute left-3 top-3.5" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
